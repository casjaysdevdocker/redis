# Docker image for redis using the alpine template
ARG IMAGE_NAME="redis"
ARG PHP_SERVER="redis"
ARG BUILD_DATE="Sat Sep  2 10:56:31 PM EDT 2023"
...
ARG SERVICE_PORT="6379"
ARG EXPOSE_PORTS="6379"
ARG PHP_VERSION="system"
ARG NODE_VERSION="system"
ARG NODE_MANAGER="system"

ARG IMAGE_REPO="casjaysdevdocker/redis"
...
RUN set -ex; \
  ...
  bash -c "$(curl -q -LSsf "https://github.com/templatemgr/redis/raw/main/install.sh")"; \
  echo ""
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/redis" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/redis" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/redis" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/redis" \
